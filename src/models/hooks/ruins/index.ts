...
export const RUINS = {
  spawn: (loc: Province) => {
    const coastal = PROVINCE.hub(loc).coastal
    ...
    const locations = window.dice
      ...
      .map(room => TEXT.decorate({ ...room, color: cssColors.subtitle }))
      .join(', ')
    ...
    const hostiles = window.dice.weightedChoice([
      ...
      },
      {
        ...
        v: {
          ...
          tooltip: '{an enraged|a malign} wilderness {spirit|elemental|eidolon} protects this site'
        }
      },
      {
        w: 1,
    ...
    const treasure = window.dice.choice([
    ...
    return {
      subtitle: `${subtype} (${TEXT.decorate({
        label: 'ruins',
      ...
      content: [
        ...
        { label: 'treasure', text: treasure },
        { label: 'locations', text: locations }
      ]
    }
  }
}
