import { WarHooks } from '../types'

export const wars: WarHooks = {
  'Border Dispute': {
  ...
  'Hired War': {
    ...
    things: [
      ...
      'Weapons cache undeniably from the warmongers'
    ],
    places: [
  ...
  'National Vigor': {
    ...
    things: [
      ...
      'Weapons cache seized from the unsuspecting target'
    ],
    places: [
