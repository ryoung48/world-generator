...
export const backgrounds__community: Record<Community, Background> = {
  ...
  'population boom': {
    ...
    enemies: [
      ...
      { alias: 'Newcomer leader who despises the locals and their ways', culture: 'native' },
  ...
  'trade hub': {
    ...
    friends: [
      ...
      { alias: 'Dealer in some vital adventuring good' },
      { alias: 'Exotic stranger in need of help', culture: 'foreign' }
    ],
    complications: [
      'The locals trade with entities normally shunned by humans',
  ...
  'witch hunts': {
    ...
    enemies: [
      { alias: 'Brutal {witch-hunter|guard captain} who is going to far' },
