...
export const religions: Hook = {
  hooks: {
    'Ancient Ways': {
      ...
      complications: `Restoring a vital relic requires long-lost ritual knowledge, Something sealed away with forgotten rites is now rising again, A seemingly-harmless ritual object actually has a terrible power`,
      things: `Precious relic of old, Lost book of vital holy scripture, Hidden trove of forgotten regalia`,
      places: `Desolate temple in a dead city, Shrine lost in perilous terrain, Temple buried beneath the layers of a growing city`
    },
    'Antinomian Strain': {
      ...
      complications: `They're mostly reacting against very ugly and reprehensible moral laws, The faith is divided between antinomians and their unappealing moralist rivals, The faith is being backed by enemies of the society it is trying to deconstruct`,
      things: `Proof of a holy leader's horrible crimes against others, Treasure seized by amoral priestly thief, Indulgence document allowing the bearer to perform any one crime without repercussions`,
      places: `Orgiastic and violent religious festival, Beatific commune with dark underside, Decadent salon of highly intellectual degenerates`
    },
    Aristocratic: {
      ...
      enemies: [
        ...
        { title: `Younger noble embittered by POS shelving`, youth: true },
      ...
      complications: `The religion actually requires a noble bloodline for certain ritual and pragmatic necessities, Commoners are forming illicit parallel congregations, High religious offices have no spiritual worth at all but are only political bargaining chips among noble houses`,
      things: `Fabulously costly regalia of a dead king-priest, Once-lost text proving the commoner bloodline of a major house, Tithe-trove of loot extracted from commoners`,
      places: `Cathedral-palace of a prince-bishop, Shrine adorned by generations of a noble house, Ornate ceremony attended only by nobility`
    },
    Ascetic: {
      ...
      complications: `A faction of the faith is deeply luxury-loving via thin rationalizations, The faith is always pushing for idealistic but impractical laws, The ascetic rites change the priests in both positive and negative ways`,
      things: `Abandoned treasures of a formerly-rich cleric, Hidden wealth enjoyed by a hypocritical priest, Deed to vast temple land holdings used to support the ascetics`,
      places: `Harshly simple and uncomfortable monastery, Crude forest hermitage, Stark and bare monastic cell within a luxuriant noble palace`
    },
    'Bad Leadership': {
      ...
      complications: `The leader is seeking a goal vital to the faith's survival but doing it in a very stupid way, The leader's personal wealth or power are critical to the faith's health, The leader's rivals all hate each other more than him`,
      things: `Proof that the leader was illegitimately chosen, Treasure or relic that the leader allowed to become lost, Blackmail material that is keeping the leader's rivals from acting`,
      places: `Confused and poorly-run cathedral, Half-built folly ordained by the leader, Derelict and abandoned monastery`
    },
    'Caste Structure': {
      ...
      complications: `The caste system has some objective magical or spiritual grounding, Caste roles change with political or social changes, The current downtrodden were formerly the elite downtreaders`,
      things: `Evidence of a person's real and unsuitable caste, Tribute accumulated by a laboring caste, Hidden sacred texts that prescribe a very different caste arrangement`,
      places: `City quarter of carefully-separated caste groupings, Shrine meant for a specific caste's usage, Graveyard arranged by caste`
    },
    Crusading: {
      ...
      complications: `The crusade has very sympathetic aims but may be going too far, The crusaders have unimpeachable doctrinal support for their bloodshed, The crusade is redirecting energy from an entirely different social problem`,
      things: `Payment for vital mercenary support, Precious offering made to support the crusade, Treasure hidden by locals killed in the fighting`,
      places: `Once-harmonious town now split in savage sectarianism, Burnt temple of the rival faith, Massacre site of infidels or captured crusaders`
    },
    'Dire Sacrifices': {
      ...
      complications: `The price paid strengthens the faith directly in some way, Other people can be made to pay the price in the aspirant's place, The more a cleric pays the greater their standing in the faith`,
      things: `Tribute offered up as part of the price, Precious goods abandoned by those who need them no more, Potent relic created by terrible sacrifices`,
      places: `Grim temple stained by sacrifice, Cloister marked by the scars and losses of those who dwell in it, Ossuary or burial ground for those expended by sacrifice`
    },
    Dualist: {
      ...
      complications: `Which aspect is considered evil is based on which sect has the most power, The negative aspect is vital to human life in some way, The negative aspect is totally and violently rejected by all but the most depraved`,
      things: `Lost holy scripture full of terrible truths, Regalia of a now-proscribed priesthood to an illicit aspect, Dark artifact that is terrible but must not be destroyed`,
      places: `Hidden shrine to the negative aspect, Grand temple to both faces of the god, Fane to one aspect that used to belong to the other`
    },
    'Economic Role': {
      ...
      complications: `The faith's origins lie in their economic role, Their economic importance was foisted on them by foolish or pious aristocrats, The religion is little more than a skin over the business`,
      things: `Earnings extracted from their clients or customers, Precious goods only they are allowed to trade in, Capital amassed for some great economic project`,
      places: `A temple that's more a counting-house, Extravagantly ornate religious buildings, Industrial site designed with monastic influences`
    },
    'Esoteric Doctrine': {
      ...
      complications: `There are multiple inner doctrines that struggle against each other, The innermost secrets are lost and the hierarchs seek them constantly, The secrets are actively toxic to those unprepared for them`,
      things: `Book of forbidden truths, Encryption key to unlock a lost text, Obscure relic with tremendous hidden importance`,
      places: `Tightly-guarded sanctum within a great cathedral, Hidden shrine where the elect gather, Forbidden library of secret doctrines`
    },
    'Ethnic Creed': {
      ...
      complications: `A conspiracy theory about the faith is half-correct in a totally unexpected way, The faith is a prize of war and its rule won by former conquest, The youth are largely disinterested in it`,
      things: `Ancient relic of a culture-hero, Proof a major cleric is of the wrong lineage for their station, Awkward secret that would make trouble for the faith`,
      places: `Shrine in an ethnic neighborhood, Chapel tucked away in a rich believer's estate, Festival ground for an elaborate ethnic celebration`
    },
    'Failing Faith': {
      ...
      enemies: [
        ...
        { title: `Corrupt hierarch concerned only with POS own gain`, veteran: true },
      ...
      complications: `The fall is due to a reform campaign gone terribly wrong, The faith has become identified with a hated group or traitor faction, The faith has fragmented into mutually-recriminating sects`,
      things: `Treasure seized from an abandoned temple, Land now taken by a rival group, Sacred regalia of a recently-murdered hierarch`,
    ...
    'Folk Religion': {
      ...
      enemies: [
        ...
        { title: `Local grandee who considers the faith as much POS property as are POS serfs` },
      ...
      complications: `The primitive rituals conceal a much deeper and more sophisticated doctrine, The religion is an offshoot of a more developed creed, The crudity of the rites is identified as a sign of sincerity and sanctity by many`,
      things: `A precious and ornate offering made by a rich commoner, A relic of a local saint honored by natives, Prized idol esteemed as having holy powers`,
      places: `Rustic shrine with simple offerings, Hidden gathering place in the wilderness, Crude but imposing religious monument in a village`
    },
    'Forbidden Faith': {
      ...
      complications: `The faith really is every bit as horrible as people think, The faith has sympathetic elements but is dedicated to a principle totally inimical to the surrounding culture, The faith has agents everywhere`,
      things: `Secret list of local believers, Hidden relic revered by the faith, Holy relic now held by their enemies as a trophy`,
      places: `Hidden chamber in a rich believer's house, Secret shrine in the wilderness, Chapel concealed in a city's slums or underways`
    },
    Gnostic: {
      ...
      complications: `The secrets have a physical effect on those who know them, The secrets themselves are just tools by which other powers are manipulated, The secrets have been lost and only the leadership knows that`,
      things: `Volume of inner truths written by a renegade, Book of explosively dangerous errors penned by a heresiarch, Precious object with a secret and terrible purpose`,
      places: `Silent monastery of aspiring students, Secret sanctum of the hidden masters, Welcoming temple of the outer truths`
    },
    'Holy Grounds': {
      ...
      complications: `Control will soon be passing to an extreme sect, The holy sites have great economic or military value to the possessors, The terrain around the sites is dangerous to pilgrims`,
      things: `Sacred object which defines the holy site, Relic lost by a pilgrim to the site, Trove of offerings made by pilgrims`,
      places: `Guarded entrance to the holy site, Inner sanctum of a site for the most elect, Raucous bazaar set up to supply pilgrims`
    },
    Localized: {
      ...
      complications: `The sects worship different gods but think it's the same being, The different sects must cooperate for a ritual reason despite their disagreements, Local rulers strongly encourage disunity`,
      things: `Unique relic specific to a local sect's doctrines, Proof that a particular local doctrine is the authentically correct tradition, Relics of a local saint unrecognized elsewhere`,
      places: `Strange-looking local temple, Compromise chapel where multiple sects all pray, Special ritual area for a ceremony practiced only here`
    },
    'Materially Luxuriant': {
      ...
      complications: `The opulence has a very real magical or economic benefit, Almost all religious matters have been reduced to questions of offering-prices, The greatest luxuries are offerings of services or blood`,
      things: `Ridiculously jeweled golden idol, Large trove of precious unworked raw materials, Priceless regalia donated by a believer`,
      places: `Gilded shrine of opulent make, Workshop full of artisans for the faith, Counting-house staffed by clerics`
    },
    'Militarized Faith': {
      ...
      enemies: [
        ...
        { title: `Ruler cynically manipulating the faith against POS opponents`, veteran: true }
      ],
      friends: [
      ...
      complications: `The faith has an extremely good reason to constantly be on a war footing, Their martial practices are just a ceremonial shadow of their former ancient prowess, The faith used to be more pacifistic but only the martial zealots are still alive`,
      things: `Famed relic weapon of the faith, Large cache of arms and armor, Relic lost in battle by the faith`,
      places: `Monastery turned boot camp, Barracks-temple for the faith, Bishop-general's field camp`
    },
    'Missionary Zeal': {
      ...
      complications: `The faith is strongly identified with a particular nation or ethnicity, The faith relies on its splendor and sophistication to overawe natives, Merchants and rulers use the faith to establish a beachhead in foreign lands`,
      things: `Foreign religious treasures abandoned by rich new convert, Relic from the first native saint of the faith, Native relic sought by missionaries and locals alike`,
      places: `Converted local temple turned to the new faith, Burnt-out home of a new convert, New community of local converts`
    },
    'Monastic Clergy': {
      ...
      enemies: [
        { title: `Depraved abbot using monastic privacy for POS own ends`, veteran: true },
      ...
      complications: `All the faith's senior clerics must be drawn from monastics, The monasteries are major economic or military strong points, The monasteries protect books or secrets of the faith`,
      things: `Vast and ancient monastery, Hard-pressed young monastery in dangerous terrain, Village founded outside a monastery's walls`,
      places: `Rustic shrine with simple offerings, Hidden gathering place in the wilderness, Crude but imposing religious monument in a village`
    },
    Monolatrists: {
      ...
      friends: [
        {
          title: `Apostate from another faith seeking only to be left in peace by their former co-religionists`
        },
        { title: `Missionary seeking to spread the true faith` },
        { title: `Ruler backing the faith for unity's sake`, veteran: true }
      ],
      complications: `The monolatrists have excellent reasons not to worship other gods, They seek to forbid other faiths in nations they control, They're convinced the other faiths want to destroy them and act accordingly`,
      things: `Relics from a defeated faith taken as trophies, Evidence proving an important believer is secretly revering other gods, Lost monolatrist relic taken by a rival faith`,
      places: `Ruins of a destroyed rival temple, Hidden cell of illicit believers, Splendid temple to the sole god`
    },
    Multicephalous: {
      ...
      complications: `One pontiff has theoretical supremacy but no practical control, The pontiffs are mere puppets of their respective secular rulers, One or more pontiffs are engaged in a hot religious war`,
      things: `Lost holy scripture proving one of the prelacies is invalid, Extremely precious bribe to a pontiff, Holy relic conferring great spiritual authority on the owner`,
      places: `Twinned churches revering different heads, Former temple of one sect now controlled by another, Ancient shrine from before the splintering`
    },
    'Mutilated Clergy': {
      ...
      complications: `The mutilation grants some sort of power to the subject, A third party can suffer the mutilation on the priest's behalf, The higher one's rank the more complete the mutilation`,
      things: `Mutilated relic of a famous saint, Cure for a regretful cleric, Precious implement used as part of the mutilating process`,
      places: `Hospital area for recovering initiates, Shrine adorned with sculptures of maimed priests, Temple staffed with mutilation-flaunting clergy`
    },
    'New Dispensation': {
      ...
      complications: `The new dispensation is very advantageous to the local secular rulers, The divide is drawn sharply between different classes or regions, The new dispensation is actually false and the work of some dark power`,
      things: `Secret roster of old faith supporters, Holy relic spirited away by traditionalists, Wondrous relic created by the new dispensation`,
      places: `Refitted temple with new symbols, Rustic shrine that has yet to convert, Prison-monastery for recalcitrant clerics`
    },
    Quietist: {
      ...
      complications: `The quietists enforce their principles with murderous violence, The quietists are trusted to handle certain very important matters by the culture, The quietists command great wealth but use very little of it`,
      things: `Book of hidden enlightenment, Humble object sanctified into holiness by its possessor, Secret prophecy made by a quietist seer`,
      places: `Austere wilderness monastery, Quiet self-contained rural community, Private cell for retreat in a luxurious urban home`
    },
    'Reformist Struggle': {
      ...
      complications: `The reformists are actually full of terrible ideas that will inevitably bring ruin, The faith has become corrupted due to an outside force rather than mere moral inertia, A hostile rival group is supporting both sides to intensify the discord`,
      things: `Vast trove gathered by a venal pontiff, Stash of weapons or blackmail gathered by reformers, Holy relic conferring legitimacy on the owning sect`,
      places: `Angrily-strict reformist monastery, Corrupt temple full of venal clerics, Age-worn shrine full of pragmatic and worldly priests`
    },
    Remnant: {
      ...
      complications: `The faith's heyday was so long ago it has almost been forgotten, The faith only very recently collapsed into this ruin, Another sect of the faith is still strong and active`,
      things: `Treasure lost in the faith's collapse, Ancient relic from a now-lost temple, Trophy that would revive the faith's fortunes`,
      places: `Ruined temple from a lost age, Freshly-wrecked shrine from a chaotic fall, Half-empty temple that was once full`
    },
    'Restricted Membership': {
      ...
      complications: `The faith is restricted for a very pragmatic reason, The faith makes up in social cachet or money what it lacks in numbers, The faith is hardly a religion at all so much as an influence society`,
      things: `Proof a hierarch does not qualify to belong to the faith, A sacred object characteristic of the faith's membership, Evidence that a great saint was not of the right kind`,
      places: `Combination guild or community center and temple, Well-guarded shrine sealed against outsiders, Neighborhood exclusive to the membership`
    },
    'Rival Religion': {
      ...
      complications: `A third party is profiting greatly from the struggle, One faith is getting desperate and willing to go to extremes, The rivalry is ancient and formalized`,
      things: `Literal or metaphorical weapon to ensure victory, Deed to precious disputed property, Right to oversee a ceremony of great social importance`,
      places: `Shrine heavily fortified against attack, Institution poisonously divided between believers, Bloody pogrom site of local minority faith`
    },
    Schisms: {
      ...
      complications: `The schism was born out of an abortive reform effort, The schism is the fruit of a catastrophic failure of leadership, The schism was born when the leadership became puppets of a hostile power`,
      things: `Holy relics of a destroyed sect, Legitimating regalia from before the schism, Sacred scripture proving one sect is correct`,
      places: `Burnt-out temple, Makeshift shrine established by a new sect, Monastery torn into multiple feuding groups`
    },
    Simony: {
      ...
      complications: `The government extracts much of the simoniacal wealth from the faith, Clerical titles are actually liquid fiat currency to be exchanged, The faith pays merchants and others in clerical titles`,
      things: `Massive trove of donated wealth, Token that grants the bearer a great title, Masterwork offered by a great crafter for a title`,
      places: `Hidden vault of an arch-priest, Auction house where titles are sold, Oligarch's temple-villa`
    },
    'State Faith': {
      ...
      complications: `The faith is bifurcated into purely spiritual members and secular clerics who have all the worldly influence, The faith is explicitly headed by the ruler, Doctrines keep changing to suit secular needs`,
      things: `Ancient scripture from before its adoption as state faith, Government-collected tithes, Wealth entrusted to the faith for safeguarding`,
      places: `Glorious national temple, Monastery that is more like a bureaucratic office, Vast plaza for grand religious rites`
    },
    'Stratified Practice': {
      ...
      complications: `The practices are meant to keep social orders in their correct places, Some practices are secret even from other believers, Certain practices are outright forbidden to all but the great and noble`,
      things: `Valuable regalia required for certain elite practices, Tome revealing that a low-class practice is most correct, Gaudy but priceless idol fashioned by rich commoner believer`,
      places: `Worship site that looks nothing like another nearby worship site, Restricted shrine for a particular group, Forest clearing for a forbidden practice`
    },
    Syncretists: {
      ...
      complications: `The faith intentionally erases all troublesome history of assimilated faiths, The faith has a very mercenary attitude toward all aspects it serves, The faith is riven by numerous utterly incompatible doctrines`,
      things: `Lost holy idol of a forgotten faith, Tome with a dark truth about a popular aspect, Holy relic commandeered by the new faith`,
      places: `Temple with numerous new additions, Converted shrine of an assimilated faith, Open-air revival where the new doctrine is being taught`
    },
    'Underclass Faith': {
      ...
      enemies: [
        ...
        { title: `Cynical priest milking POS poor flock` }
      ],
      friends: [
      ...
      complications: `The faith was designed as a synthetic tool to reinforce existing class structures, Secret sympathizers exist among the elite, The faith has real power via its influence on the masses`,
      things: `Tithe of some resource vital to poor believers, Relic of a great champion of the poor, Trove of some precious good produced by socially-disdained crafters`,
      places: `Tumbledown shrine in the slums, Secret shrine in a wealthy household, Hidden camp of pariah-zealots`
    },
    'Upstart Underclass': {
      ...
      complications: `A faction of the faith bitterly resents the low-class upstarts, The low-class members have very different goals for the faith than the upper-class ones, The permissibility of underclass leadership hinges on a single vulnerable doctrinal ruling`,
      things: `Rich new convert's huge donation, Blackmail collected by an intimate servant who converted, Token of legitimate possession of an important socio-religious position`,
      places: `New temple raised in a poor part of town, Somewhat gaudy and nouveau-riche shrine of a lower-class priest, Exclusive club with loud new members`
    },
    Venality: {
      ...
      complications: `The venality is hidden or discussion of it is harshly suppressed, The venality exists and is self-reinforcing only in the upper leadership, The secular leaders use the faith's avarice to control it`,
      things: `Rich prelate's fabulous wealth, Exotic delight craved by hierarchy, Undeniable proof of a high priest's corruption`,
      places: `Luxuriantly-appointed private clerical villa, Factory or warehouse dedicated to clerical needs, Village impoverished by clerical exactions`
    },
    'Vital Service': {
      ...
      complications: `Providing this service exacts a brutal cost on those who serve due to environmental dangers or manufacturing processes, This service is key to controlling large amounts of money or influence via secondary effects, The faith is intimately entwined with relevant craft guilds`,
      things: `Secret handbook of the deepest lore of the service, Lost tool vital to providing the service, Vast trove earned by the service`,
      places: `Bustling manufactory of the service, Market or distribution point for the service, Temple adorned with symbols and signs of the service`
    }
  },
  subtype: ({ loc }) => {
