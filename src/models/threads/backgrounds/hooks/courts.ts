import { hub__alias, hub__isVillage } from '../../../regions/provinces/hubs'
...
export const courts: Hook = {
  hooks: {
    ...
    'Iron Law': {
      ...
      places: [
        'Chamber of judgment',
        'Punishment place for offenders',
        'Site of the growing problem'
      ]
    },
    'Lost Purpose': {
  ...
  subtype: ({ loc }) => {
    ...
    return window.dice.spin(
      window.dice.weightedChoice([
        { w: village ? 0 : 1, v: `{noble household|${hub__alias(loc.hub)} leadership}` },
        { w: village ? 0 : 1, v: `{artisan guild|merchant consortium|{merchant|banking} house}` },
        { w: village ? 0 : 0.5, v: `sorcerous {cabal|conclave}` },
