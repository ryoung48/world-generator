import { hub__alias, hub__isVillage } from '../../../regions/hubs'
import { Hook } from '../types'

export const courts: Hook = {
  hooks: {
    "Affliction's Mark": {
    ...
    'Awesome Legitimacy': {
      ...
      enemies: [
        ...
        { title: "Manipulator who cloaks POS will in the court's legitimacy" },
    ...
    'Blandished Leadership': {
      ...
      complications: `The paramours have a supernatural edge in their charms, Their spouse likes them distracted so as to carry out their own plans, The court is fighting over influence with the paramours rather than the leadership`,
    ...
    'Cadet Branches': {
      ...
      enemies: [
        { title: 'Disgraced scion with a plan for revenge' },
        { title: 'Ruler who hates a particular branch', veteran: true },
        { title: 'Scheming leader of a minor branch' }
      ],
      friends: [
        { title: 'Bastard offspring seeking recognition' },
        { title: 'Visionary from a cadet branch' },
        { title: 'Rightful leader denied their place' }
      ],
    ...
    'Decadent Court': {
      ...
      complications: `The court's leadership is uninvolved and using the vices to blackmail and control their underlings, The court's trying to spread its vices in its own social stratum and profit accordingly, A faction is taking things much too far even for their brethren and involving occult powers`,
      things: `Debt-slave contracts, Hideous but precious idol or art object, Valuable drug made from slaves`,
      places: `Debauched salon, Court public hall made sinister, Pit where the human chattel are kept`
    },
    "Devil's Bargain": {
      ...
      friends: [
        ...
        { title: 'Enemy of the power they pacted with', monstrous: true }
      ],
      complications: `Only a small faction of the court knows about the bargain, The current leadership didn't know about the deal until it was threatened into compliance, The power they pacted with is a mortal enemy of their society`,
      things: `Blackmail material the pact granter is using to control them, Potent relic granted in the deal, Heavy tribute due to the pacting power`,
      places: `Monument to the victory the pact secretly gave them, Secret chambers for the pact's granter, Shrine to the dark entity they propitiated`
    },
    'Diplomatic Demands': {
      ...
      complications: `The exactions demanded are purely punitive, There's a specific temporary reason the court has to acknowledge the demands, Another party could give a better deal if they were persuaded`,
      things: `Huge down payment on the demands, The precious object the court is trying to acquire, Proof that the demands are unjustified`,
      places: `Diplomatic retreat full of tense people, Site of the problem causing the demands, Hushed court hall full of whispers`
    },
    'Disputed Inheritance': {
      ...
      complications: `Legitimacy rests on possession of a now-lost relic, If the struggle lasts much longer the patrimony will be ruined or lost, A selfish regent is exploiting the court during the interregnum`,
      things: `Bribe intended for the faction leaders, Precious relic of legitimacy, The real and verified will`,
      places: `Tense and angry court meeting hall, Heir's country estate, Court plaza where the factions don't mingle`
    },
    'Excess Heirs': {
      ...
      complications: `The ruler desires a Darwinian culling of heirs, The court desperately needs the heirs to cooperate to overcome a threat, Several heirs were formerly unknown`,
      things: `Proof of a candidate's illegitimacy, Bribe from an enemy power, Relic meant to eliminate a rival`,
      places: `Well-fortified home of an heir, Court hall where the factions are well-separated, Ritual occasion of enforced amity`
    },
    'False Prize': {
      ...
      complications: `The prize's benefits will attract an overwhelming foe, The prize will corrupt or ruin the court's leadership, The prize comes with secret problems or obligations that will plague the court`,
      things: `Proof that the prize would be a disaster, The key to unlocking the prize, Rich reward that seems to be a foretaste of the prize's benefits`,
      places: `Edifice built as part of the effort, Ruined seat of a former holder of the prize, Secret facility where terrible prices are paid in pursuit of it`
    },
    'Fatal Extravagance': {
      ...
      complications: `The extravagance is serving a secret magical or ritual purpose, It's being paid for with debt the court intends to never need to repay, The waste is the product of a new ruler who has different expectations of what they deserve`,
      things: `Shipment of precious luxuries, Payment meant for the next round of indulgences, Precious item that is to be pawned or sold to fund the luxuries`,
      places: `Gaudily-adorned court structure, Celebration of wild excess, Ostentatious and newly-built monument to their luxuries`
    },
    'Forbidden Romance': {
      ...
      complications: `The reasons for opposing the match are extremely good, The court member is being exploited by the paramour or their manipulators, A rival court member wants the match to go through so the court member will be disgraced`,
      things: `Proof that the lover is not what they seem, A gift the enamored should not have given, A token that will legitimize the pairing`,
      places: `Secret rendezvous spot, Hidden prison for a reluctant lover, Court festival where unacceptable hints are given`
    },
    'Foreign Ties': {
    ...
    'Magical Subversion': {
      ...
      things: `Charm to lift the curse or mind-bending, Proof of magical interference, The artifact being used to subvert the target`,
    ...
    'Ministerial Capture': {
      ...
      complications: `The ministers think the proper leadership is incompetent, The ministers are really serving a rival, The leadership honestly prefers to leave everything to the ministers`,
      things: `Documentation proving ministerial malfeasance, Malversated court resources, Blackmail evidence on the court leadership`,
      places: `Abandoned official audience chamber, Private residence of the ministerial kingmaker, Clerkly offices bustling with petitioners`
    },
    'New Generation': {
      ...
      complications: `The new generation is being held back by ossified existing members, They have magnificent plans that will fail spectacularly, They didn't want the jobs but were forced into them by circumstances`,
      things: `Lost treasure or resources the old guard hid, Ceremonial regalia that imbues legitimacy, Secret plans or archives that the former ruler hid`,
      places: `Newly-remodeled court residence, Audience hall adorned with freshly-changed arms, Ministerial office full of confused and harried clerks`
    },
    'New Opportunity': {
      ...
      complications: `It's a trap and will ruin those who embrace it, The ease of any one spoiler ruining it has paralyzed deliberations, The opportunity has its own ideas about who should exploit it`,
      things: `Key to unlocking the opportunity, Rich treasure safeguarded by the opportunity, Token that will allow the holder to exploit the opportunity`,
      places: `Site where the new chance is brightest, Camp or building for preparations, Site of a failed effort`
    },
    'Outside Debts': {
      ...
      complications: `Revealing the debt's existence would ruin the court, The creditor completely deserves to be paid, An old rival has bought the debt and now holds it`,
      things: `Riches needed to pay off the debt, Proof that the contract was invalid, The document or token that is needed to enforce the debt`,
      places: `Lair of the creditor, Court holding being sold or given away to help satisfy the debt, Great court ceremony made insultingly meager to save money`
    },
    'Overextended Grasp': {
    ...
    'Proxy Speaker': {
      ...
      friends: [
        { title: 'Worried child of the leader' },
    ...
    'Shining Successor': {
      ...
      complications: `The successor is a genius but has truly horrible traits as well, The successor is being backed by a rival who thinks to use them, The successor's talents are vast but are precisely the wrong skills for the situation they will face`,
      things: `Regalia due to the rightful heir, A marvelous work produced by the successor, Proof that the successor has no legitimate claim on rulership`,
      places: `Salon where the successor shines brilliantly, Site of a grand triumph by the successor, Throne room where the successor gets more attention than the ruler`
    },
    'Splendid Seat': {
      ...
      enemies: [
        ...
        { title: 'Hostile entity bound or associated to the seat' }
      ],
      friends: [
      ...
      complications: `The seat exacts a cost from those who dwell there, The seat's real power is misunderstood by all save the ruler's inner circle, The seat is somehow a prison as well as a throne`,
      things: `Key to unlocking the seat's secret powers, Precious relic of a former age, Wealth obtained through the seat's qualities`,
      places: `Strange chamber of some long-lost purpose, Hidden room deep within the structure, Grand and magnificent structure embodying the site`
    },
    'Ruling Regalia': {
      ...
      complications: `The relics were lost some time ago and are currently forgeries, The power of the relics is objectively necessary for the ruler to function, A bearer will die if the relics are removed for too long`,
      things: `Device that will destroy or nullify a relic, Perfect forgery of a relic, Another relic perfectly identical in all ways`,
      places: `Tightly-guarded repository for the relics, Ceremonial procession showing the relics, Court structure or edifice powered by the relics`
    },
    'Runaway Rule': {
      ...
      complications: `The group has considerable outside backing, The group really is doing something critical to the court's function, The court is now actually incapable of handling the group's duties`,
      things: `Wealth obtained by the group's actions, Treasure given to the group originally to induce them, Powerful relic obtained by the group as a tool`,
      places: `Structure dedicated to the group's devolved duty, Country estate of the group's leader, Abandoned structure of the court that once handled it`
    },
    'Sublime Skill': {
  ...
  subtype: ({ loc }) => {
    ...
    return window.dice.spin(
      window.dice.weightedChoice([
        {
          w: village ? 0 : 1,
          v: `{noble household|${hub__alias(loc.hub)} leadership}`
        },
        {
          w: village ? 0 : 1,
          v: `{artisan guild|merchant consortium|{merchant|banking} house}`
        },
        { w: village ? 0 : 0.5, v: `{sorcerous|occult} {cabal|conclave}` },
        { w: village ? 0 : 0.5, v: `{chivalric|templar} order` },
        { w: village ? 1 : 0, v: `{familial clan|${hub__alias(loc.hub)} leadership}` },
        { w: village ? 0.1 : 1, v: `criminal {syndicate|gang|brotherhood|cartel}` },
        { w: village ? 0.1 : 1, v: `{religious order|sacred {temple|monastery}}` }
      ])
    )
  }
}
...
// const _main = async () => {
//   const court = `a criminal gang`
//   for (const [k, v] of Object.entries(courts.hooks)) {
//     console.log(k, cache)
//     if (cache[k]) continue
//     try {
//       cache[k] = JSON.parse(
...
//       ${v.text}
//       * enemies: ${v.enemies.map(e => e.title).join(', ')}
//       * friends: ${v.friends.map(e => e.title).join(', ')}
//       * complications: ${v.complications}
//       * things: ${v.things}
//       * places: ${v.places}

//       Rephrase this tag to be for an adventure involving ${court}. Keep all of the main elements the same, but replace all generic court references with friends, enemies, complications, places, and things that would be relevant to ${court} in a fantasy RPG setting. Make sure there are at least five examples for each of friends, enemies, complications, places, and things. Make sure the text is at least 75 words long. Be as specific as possible when describing friends, enemies, complications, places, and things. Output the result as a JSON with the following format:
//       {
//           "text": string;
...
//           "places": string[];
//       }
//       Do not output anything other than the JSON. Do not mention any modern technology or terminology such as guns, firearms, police, vehicles, cars, hacking, databases, cybernetics, photos, or recordings.`)
//       )
//     } catch (e) {
//       console.log(e)
//       continue
