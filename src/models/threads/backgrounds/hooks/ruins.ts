...
const affix = '{ancient|crumbling|overgrown|destroyed|abandoned}'

export const ruins: Hook = {
  hooks: {
    'Abandoned Traps': {
      ...
      enemies: [
        ...
        { title: 'Vicious scavenger of trap victims' },
      ...
      complications: `The traps keep something in, The traps are intelligent, The traps have been suborned, The “traps” were never meant to be`,
      things: `Key to deactivate traps, Precious thing the traps guard, Map of trap placement, Magical protection from the traps`,
      places: `Innocent room, “Obviously trapped statue” chamber, False treasure cave, Clearing littered with remains of victims`
    },
    'Ancient Archives': {
      text: `The site once housed archives or information that would be very interesting to certain modern powers. The utility or value of this information should be obvious to the players, even if they're initially unaware of its existence. Known archival sites might have sealed their lore behind some fearsome guardian or a “puzzle” consisting of access procedures that were self-evident in the age it was constructed in.`,
      enemies: [
    ...
    'Civil War': {
      ...
      things: `The artifact they're fighting over, Weapon to destroy their rivals, Wealth to bribe other helpers`,
    ...
    'Desperate Hunger': {
      ...
      enemies: [
        ...
        { title: "Native leader who'll do anything to feed POS people" },
    ...
    'Dueling Explorers': {
      text: `Someone else seeks to explore the dungeon at the same time as the PCs, and they are not interested in sharing their finds. One or more groups compete with the hero to plunder the place or race them in search of the mighty relic rumored to be buried there. Some of them may be willing to negotiate with the PCs, while others would sooner see their rivals dead.`,
      enemies: [
        { title: 'Gold-crazed freebooter' },
        { title: 'Ruthless tomb thief' },
        { title: 'Rapacious sage of lost treasures' },
        { title: 'Local lord with a lust for their “rightful due”' }
      ],
      friends: [
        { title: "Patron backing the hero's efforts" },
        { title: 'Rival of an enemy group' },
        { title: 'Dungeon denizen wanting protection' },
        { title: "The ruin's true owner" }
      ],
      complications: `The “destruction” is metaphorical or societal in nature, Only a specific part of the ruin will be destroyed, No one involved realizes that it will cause a somewhat slow-motion destruction`,
      things: `Device that will undo the link, The precious object that is the heart, Relic to control the linked things`,
      places: `Chamber where the heart's connection is visible, Place that shifts in sympathy to the heart, Damaged room reflecting damage to the heart`
    ...
    'Hiveminded Natives': {
      ...
      friends: [
        ...
        { title: 'Telepathic ally with similar abilities', monstrous: true }
      ],
      complications: `The hivemind's doubts are embodied in conflicting factions, It can focus only on so many bodies at once, It requires a connection to issue new orders, The hivemind's telepathic link has been {disrupted|tampered} with causing communication breakdowns and confusion, The hivemind is in the process of integrating a new powerful entity into its collective causing instability and infighting among its members.`,
    ...
    'Lethal Treasure': {
      ...
      places: `Hellish processing or production area, Tightlyguarded vault of the good, Area made toxic by the good's effects`
    },
    'Limited Access': {
    ...
    'Lingering Curse': {
      ...
      friends: [
        ...
        { title: "Sympathetic native struggling with the curse's effects", monstrous: true }
      ],
    ...
    'Lost Colony': {
      text: `The ruin was once a colony site for a now-vanished empire or people. Some of these pioneers might still survive within, albeit doubtless in much-changed form, or else their belongings might include objects or relics that would be very valuable today. The modern heirs to this lost domain might still consider the ruin to be their lawful property, and all within it to be theirs.`,
      enemies: [
        { title: 'Degenerate colony leader' },
        { title: 'Outside conqueror seeking to seize the site' },
        { title: 'The hideous thing that destroyed the colony', monstrous: true }
      ],
      friends: [
        { title: 'Confused surviving pioneer-heir' },
        { title: 'New colonist trying to revive the place' },
        { title: 'Historian looking for relics' }
      ],
    ...
    'Magical Wonder': {
      ...
      things: `Device to control the enchantment's benefits, Ruined enchantment parts that are valuable still, Research notes that would allow it to be repaired`,
    ...
    'Royal Refuge': {
      text: `Some exiled noble, unsuccessful pretender, hunted wizard, or other grandee of note remained here for a time, either willingly or under duress. They and their retinue left their traces behind, and remnants of the group might still be present. The principle figure probably died here, though some kinds of creatures or wizards may have been less susceptible to time.`,
      enemies: [
      ...
      friends: [
        ...
        { title: 'Local chief trying to keep POS village out of the affair' },
    ...
    'Shifting Interior': {
      ...
      friends: [
        { title: 'Friendly native guide', monstrous: true },
    ...
    'Taboo Place': {
      ...
      friends: [
        ...
        { title: "Native who doesn't believe in the taboo" },
      ...
      places: `Exemplary warning-pike with heads attached, Long-sealed entrance portal, Vigilant guard post`
    },
    'Things Below': {
    ...
    'Useless Treasure': {
      ...
      friends: [
        ...
        { title: 'Native denizen who knows the treasure is worthless' }
      ],
    ...
    "Wizard's Lair": {
      ...
      places: `Chamber with a half-finished and dangerous enchantment, Pens for alchemical monstrosities, Living quarters that are physically impossible somehow`
    }
  },
  subtype: ({ loc }) => {
    const { coastal } = loc.hub
    return window.dice.spin(
      `${window.dice.weightedChoice([
        { w: 1, v: `now-incomprehensible wreckage` },
        { w: 1, v: `{abandoned|destroyed} {mine|tunnel system}` },
        { w: 1, v: `natural {cave|cavern}` },
        { w: 1, v: `${affix} {villa|manor|castle|compound|fortress|watchtower}` },
        { w: 1, v: `${affix} {village|town|city}` },
        { w: 1, v: `${affix} {laboratory|academy|vault|prison}` },
        { w: 1, v: `${affix} {shrine|temple|monastery|crypt|monument}` },
        { w: 1, v: `magical disaster site` },
        { w: coastal ? 0.5 : 0, v: `{{military|merchant} shipwreck|${affix} lighthouse}` }
      ])}`
    )
  }
}
