...
import { hub__alias } from '../../../regions/hubs'
...
export const communities: Hook = {
  hooks: {
    ...
    'Awful Curse': {
      ...
      complications: `Failing to lift the curse will cause a disaster, The curse is a fake, a cover for some dark crime, The curse is keeping an invader out of the place, The curse is tied to an innocent local's life, The curse's side-effects are making someone rich, The locals are convinced they deserve the curse, The locals have a badly wrong idea how to lift it, Their rival neighbors want the curse to stay active, `,
      things: `The artifact that can be used to lift the curse, The evidence proving a person responsible for it, The item that must be returned to lift the curse, The magical belongings of a deceased curse-lifter, The map to where the curse's focal item is buried, The money paid to the person who laid the curse, The possessions of a rich victim of the curse, The relic that must be shattered to lift the curse, `,
      places: `A chamber where the curse's focal relics are held, A hidden lair for the maintainer of the curse, A place for magical workings to prolong the blight, A tavern where locals gloomily talk of the blight, Grim locale where locals suffered the curse's effect, Hiding-spot for someone accused of laying it, Panicked local meeting to discuss the curse, The site of a crime that induced the curse, `
    },
    'Bad Neighbors': {
    ...
    'Bad Water': {
      ...
      complications: `The locals need to move as the land can no longer support their crops, Some vital local industry is poisoning the waters, A curse has fallen on the water due to some local crime`,
    ...
    'Blood Feud': {
      ...
      complications: `The families were formerly the closest of allies, One family is favored by local rulers, One of the families have a history dabbling in dark sorcery, The families are crippling the city's law enforcement and criminals are taking over, A cold tension is about to turn into a hot war if a recent crime is assigned to one clan`,
      things: `A treasure the groups are fighting over, Lost symbol of peaceful unity, Proof that the original slight was a fabrication, Evidence of outside agitation`,
      places: `Bloody back alleyway, Riotous street brawl between partisans, Bloodstained wedding hall, Venomously polite meeting`
    },
    ...
    'Corvee Demand': {
      ...
      complications: `The corvee is actually a legitimate demand, The corvee is being used to build some vital infrastructure, The corvee was supposed to be paid work`,
      things: `The pay that was supposed to be given to the workers, Proof of the demand's falsification, Evidence of corrupt redirection of the corvee labor`,
    ...
    Crackdown: {
      ...
      complications: `The locals are getting frustrated with all the new enforcement too, The numerous new petty regulations are actually part of a huge and sinister ritual, The new legalism is part of a zealous religious revival.`,
    ...
    'Crop Failure': {
      ...
      complications: `Aid is only being distributed to the politically reliable, The community is collapsing into famine-driven strife, The crop failure is caused by a curse, The crop failure is a contagious plant disease and what little food remains must be burnt before it spreads, The crops were destroyed in the field by enemies`,
      things: `A pillaged caravan of food aid or edible provender, A magical object that creates large amounts of food, An ancient treasure able to buy a vast sum of food, Precious belonging that was traded for bread, Hidden stockpile of grain laid down by rebels, Written trade agreement that would bring in food, Contractual claim on a large shipment of food, Stolen alms-gold set aside to buy food for the poor`,
      places: `Black market selling food meant for relief or alms, Riotous center for distribution of food and alms, Withered field where even the shoots have been eaten, Empty storehouse where people have plucked rice grains from between the boards`
    },
    'Crop Theft': {
      ...
      complications: `The thieves stole because they will starve otherwise, The food hasn't been preserved yet and will spoil soon if not reclaimed, The thieves took even the seed grain for the next crop`,
      things: `Map to the food's hiding place, Proof that the requisition was unlawful, Newly-discovered food source`,
      places: `Barren field, Crude infirmary filled with those injured in the raid, Quarrelsome courtrooms`,
      constraints: { urban: false }
    },
    'Cultural Center': {
    ...
    'Dark Cult': {
      ...
      enemies: [
        ...
        {
          title: 'Ruthless hierarch who leads the cult for #possessive# own aims',
          veteran: true
        }
      ],
      friends: [
      ...
      complications: `The cult has a blithely innocent outer membership, The cult has no patron, only a sorcerous trickster, The cult is being backed by a hostile foreign power, The cult is being used as a catspaw by a local noble, The cult is blocking an even worse dark entity, The cult is intimately tied to the local identity and past, The cult provides a vital service to desperate locals, The cult's leader is trying to mitigate the faith's evil`,
      things: `A cure for some curse or evil the cult has inflicted, A perhaps poorly-encrypted membership list, A precious heirloom taken from the cult's last victim, Ancient sacrificial offerings to the dark god, Blackmail material against a local ruler or official, Key that can unlock the dark god's true power, The sacred book of the cult, vital to its rituals, The vile idol which is the source of the cult's magic`,
      places: `Abandoned ancient shrine once dedicated to the god, Bloody grove in the wild consecrated to their deity, Elegant salon where powerful cultists meet, Local festival with a hidden, horrible rite at its heart, Local temple or church taken over by cult members, Prison, brothel, or other place of easily-had prey, Subterranean hollow dug out by cultists of old, Vice den or tenement reeking of human desperation`
    },
    'Decadent Locals': {
    ...
    'Decaying Enchantment': {
      ...
      complications: `Part of the community would greatly profit by the enchantment's failure, The enchantment risks catastrophic eruption, The rulers punish any talk of it failing`,
      things: `A critical repair text for the enchantment, Valuable broken enchantment components, Precious resources crystallized from the enchantment's energies`,
      places: `Control nexus for the enchantment, Enterprise dependent on the enchantment, Site of a enchantment failure or accident`
    },
    'Despotic Lord': {
      ...
      complications: `One powerful local group profits much from the lord, Rival successors threaten civil war at the lord's ouster, The lord has to keep this up or they'll lose vital support, The lord is holding back an even worse outside threat, The lord is mistaken, but theoretically redeemable, The lord is much loved by their feudal master, The lord is really doing this for secret magical reasons, The strongest opposition to the lord is a very bad man`,
      things: `A holy artifact plundered from the local temple, A precious gift sent in an attempt to curry favor, Ancient text that has a secret the lord craves to know, Item of regalia that gives legitimacy to the ruler, Magical artifact that does a thing the lord direly needs, Proof for the king of the lord's unfitness to rule, Taxes collected from the cruelly-downtrodden people, The wealth the lord uses to pay his henchmen`,
      places: `Back room of a tavern where conspiracies are plotted, Barracks of brutish and abusive mercenary soldiers, Forest camp of bitter bandit-rebels, Hiding-place for women and children in the wilds, Market plagued with bullying minions of the lord, Ornate hall of a toadying minion of the lord, Scourged hamlet of oppressed peasants, Slave market where the lord's victims are sold`
    },
    'Dueling Lords': {
    ...
    'Ethnic Tensions': {
      ...
      complications: `A rival power is using the strife to weaken the land, Both sides are deeply unsympathetic to observers, One side is taking things much more seriously, One side seems totally justified in their anger, The local rulers greatly favor one side, The strife is cyclical, and most expect it to end soon, The strife is extremely profitable to a third party, The strife is rapidly building to open warfare, `,
      things: `Arms cache meant for use in the conflict, Infant kidnapped from a leader of the rival group, Magic item one group uses for defense of its people, Old document showing the truth of a divisive event, Proof of the real culprit of an outrageous crime, Remains of victims "disappeared" by their rivals, Sacred relic of one group's revered past, Wealth stolen from a rich member of a rival group`,
      places: `Monument to one group's past glorious victory, Site of a brutal crime committed by one group, Hidden wilderness camp of zealous extremists, Ethnic meeting hall for festivals and planning, Burnt-out ethnic street after a neighborhood riot, Guarded ghetto quarter of a worried minority, Audience hall of mutually-acrimonious petitioners, Torchlight parade route of violent protesters`,
      constraints: { urban: true }
    },
    'Enemy Within': {
    ...
    'Foreign Enclave': {
      ...
      enemies: [
        { title: `Ruthless independence fighter` },
        { title: `Outsider ruler with no regard for the locals` },
      ...
      friends: [
        ...
        { title: `Pragmatic-minded outsider magistrate` }
      ],
    ...
    'Foreign Spies': {
      ...
      complications: `Enemy agents strike at {secret programs|local customs} that are detestable and vile, Locals are commonly framing each other as agents to settle old scores, The agents have powerful native supporters`,
    ...
    'Foul Sorcery': {
      ...
      complications: `Only the live, cooperative wizard can undo a curse, Several wizards make up the sorcerous cabal, The wizard has a legal right to do what they're doing, The wizard has bribed or coerced local cooperation, The wizard protects as well as exploits the people, The wizard's harmless, and being framed by a foe, The wizard's help is crucial to local authorities, The wizard's intentions are of the best, if not their acts`,
      things: `Artifact of dark sorcerous might, Tome of forbidden lore, The text containing the sorcerer's secret weakness, Proof of the true identity of the evildoer, Runaway experiment of vital importance to the mage, The ancient key to unlock an artifact of the mage, The object that is the focus of the sorcerer's power, The one person who can satisfy a ritual sacrifice need`,
      places: `Hidden unsanctified ossuary, Reeking tenement in the slums, Hidden cultic shrine, Secret room in a noble's palace, Elegant country villa staffed with the wizard's minions, Temple where the wizard's prey seek sacred safety, Warped trans-dimensional pocket domain`
    },
    'Guild Oligarchy': {
    ...
    'Invading Army': {
      ...
      complications: `Local guerrillas are inciting brutal reprisals, Many of the local youth have run off to join the army, The army is bringing a great sickness or plague, The army plunders, and is under very bad discipline, The army's eating out all available provisions, The army's interfering with vital agricultural work, The army's leader is cowardly and won't advance, The local community has been wrecked in fighting`,
      things: `Blackmail sufficient to control an army's leader, Bundle of vital intelligence stolen from one side, Lost supply train with vital equipment and provisions, Payroll chest for the army's soldiers, Precious thing confiscated by one of the armies, Secret weapon held by one of the sides, Treasure left concealed by a fleeing local grandee, Vital cache of grain for winter the locals concealed`,
      places: `Burnt-out swath where the army has passed, Fortified estate or strong point held by soldiers, Hidden camp of deserters or enemy scouts, Hospital where sick and wounded are being tended, Military camp with soldiers and camp followers, Place of a gory battle, still strewn with destruction, Tavern hushed with fear of forced conscription, Torched field scattered with the dead of the farm`
    },
    'Lawless Chaos': {
      ...
      complications: `A monstrous criminal got loose during the confusion, A neighboring rival is encouraging the chaos, An incompetent official is making things worse, The bloodshed is producing undead and dark spirits, The chaos is drawing brigands and worse to the place, The government plans to restore order savagely, The locals demand a totally impractical outcome, The only legitimate authority left is brutally corrupt`,
      things: `A dark magical icon that is worsening the trouble, A holy relic that would give a side legitimacy, A symbol of legitimate rule that would calm many, A tax shipment that never reached the capital, An arms cache sufficient to shift the local balance, Documents proving the guilt of the chaos' instigator, Much-needed food sacked from a merchant caravan, Treasure plundered during the confusion, `,
      places: `Broken-into merchant's store, looted to the floor, Burnt-down government offices or palace, Deserted court with its files strewn and burnt, Empty barracks that should be holding soldiers, Fortified neighborhood with paranoid defenders, Hushed street covered by crossbow snipers, Street smeared with the remnants of a bloody riot, Torched storehouse once filled with food, `
    },
    'Lawless Class': {
    ...
    'Lethal Plague': {
      ...
      complications: `An extremely tight quarantine is in place, Civil society has broken down entirely in the plague, Dark supernatural powers are drawn by the sickness, It's being spread by a ruthless enemy of the place, Plague victims have some magical or money value, The current treatment plan is completely wrong, The plague is a biological weapon of the ancients, The plague is only affecting an unloved group`,
      things: `A cache of gold meant to pay for food supplies, A magical cure for the plague, An old manuscript that records a cure for the illness, Deed to a dead grandee's vast estate, Heirloom taken by a person now dead in the wilds, The magical item that's causing the plague, Treasure left behind by the recently dead, Vital medical supplies to mitigate the suffering`,
      places: `Cemetery with piles of unburied plague dead, Frantic religious service praying for divine mercy, Frenetic party estate sealed off against the outside, Funeral with mourners too exhausted to mourn, Market with shrouded buyers and sellers, Overtaxed hospice for the doomed but not yet dead, Stretch of road lined with those who dropped dead, Vice den laden with the dead's scavenged wealth`
    },
    'Mad Demagogue': {
      ...
      complications: `The demagogue is the only one holding back an evil, They have a good point but are taking it much too far, The only alternative to them is something vile too, They're a secret agent of a rival power in the area, Their followers are just catspaws for their true purpose, They use a local prophecy to legitimate their acts, They're being controlled by a secret kingmaker, The government has a reason to let it burn a while`,
      things: `A vast bribe intended to avert the demagogue's wrath, Arms the demagogue needs to equip his minions, Evidence that the demagogue is an impostor or fake, Heirloom from a local noble killed early in the rising, Proof of the demagogue's real intention for the locals, The magical artifact the demagogue relies upon, Treasure buried by those who fled the demagogue, Vital supplies from a caravan the minions sacked`,
      places: `Burnt-over homestead of an un-supportive peasant, Deserted civil offices, the government now fled, Heavily-fortified estate of a worried local noble, Hushed village tavern with folk who don't dare talk, Mass meeting of demagogue supporters, Plundered home of a member of a hated group, Restive camp of the demagogue's followers, Workshop full of the demagogue's eager minions`
    },
    'Magical Academy': {
      ...
      complications: `The academy is patronized by the ruling class, The community grew around the academy, The rulers don't trust the wizards but find them too useful to get rid of them, The school was once far more powerful and is filled with half-sour old magics, The local ruler has a grudge against the school for expelling one of their relatives, The school has a bad reputation from a student turned necromancer`,
    ...
    'Natural Disaster': {
      ...
      complications: `An official is profiting cruelly on the suffering here, Higher government is unable to give any assistance, Looters and the vengeful are taking advantage of it, The locals were totally unprepared for the disaster, The disaster has revealed some lode of great treasure, The disaster will strike again soon, much worse, The disaster wrecked something they need to survive, The disaster was an arcane disruption`,
      things: `Cursed magical item that's calling forth the disaster, Great pile of plunder collected by looters in the chaos, Vital supplies needed by survivors, Rich merchant's savings he was trying to get out, The relic that will prevent the disaster from worsening, Treasure revealed by the disaster's scathing, Wealth buried in a disaster-ruined structure`,
      places: `Building full of the dead who thought it was safe, Country estate wrecked by the disaster, Ruined temple where the disaster was unleashed, Desolate neighborhood emptied by flight, Neighborhood ruined by the disaster's consequences, Once-splendid building left in ruins by the calamity, Refugee camp with miserable escapees from the disaster, Road crowded with desperate escapees from the calamity, A revealed ancient ruin`
    },
    'Neglectful Ruler': {
    ...
    'Nomadic Traders': {
      ...
      complications: `The nomads are known to become raiders during tough seasons, The nomads were recently banned from entering the community, The nomads help to keep bandits off the roads`,
      things: `Ancient nomadic relic, Stolen trade goods, Proof of local sabotage`,
      places: `Nomadic {encampment|enclave} at the outskirts of town, {Market|Trading post} where the nomads sell their wares, {Shanty town|Slum} where the nomads live`
    },
    'Pilgrimage Site': {
    ...
    'Plundered Tribute': {
      ...
      complications: `The one demanding tribute has no real right to it, The locals are cooperating to deny the tribute-gatherer, The tribute-gatherer desperately needs that tribute for some reason, The tribute itself is actually somehow dangerous or cursed`,
      things: `Sacks of worn silver coin from taxes, Bales of valuable goods, Carefully-fashioned offering vessels, Key to a hiding place`,
      places: `Secret cache in the mountains, Hidden cellar, Smuggler's cove, A hiding place in plain sight`,
      constraints: { urban: false }
    },
    'Population Boom': {
      ...
      complications: `The newcomers act like conquerors, Their cultures are extremely immiscible, The natives are now highly dependent on newcomer industry`,
    ...
    'Punishment Post': {
      ...
      complications: `The noble is a hopeless bungler, The noble wants to remain in exile despite his family's pleas, The settlement wants the noble to remain`,
      things: `Exquisite poetry or art done in exile, Proof of the injustice of the exile, The noble's uncollected pay`,
    ...
    'Raider Scourge': {
      ...
      complications: `The "bandits" are bitter victims of the locals' crimes, The bandits are being bankrolled by rival neighbors, The locals aid them in exchange for immunity, Their depredations are for fun rather than necessity, They have colorable legal authority for their thefts, They hunt for something the locals won't give up, They only look human, but have been darkly changed, They plunder under the banner of a local religion`,
      things: `A precious heirloom of seemingly meager value, A sacred relic meant to give luck to the bearer, Cache of weapons and armor for local defense, Deeds or paperwork of critical local significance, Evidence of a local traitor's cooperation with them, Hidden cache of the bandits' stolen loot, Medicine or other good vital to local survival, Money meant to pay for help in fighting the bandits, `,
      places: `A "haunted" tower the bandits know is avoided, Abandoned villa re-purposed to a camp, Hidden cave where the bandits lair, Massacre site for an ambushed caravan, Rocky outcrop with a very defensible approach, Still-smoking farmhouse burnt down by bandits, Thickly-wooded hollow deep in the hills, Unsavory way-inn where the bandits meet, `
    },
    'Rebel Stronghold': {
    ...
    Revanchism: {
      ...
      complications: `The exile's claim is completely just and reasonable, The exile committed terrible atrocities in their home kingdom, The exile is related to this region's sovereign`,
      things: `Wealth needed to fund a military campaign, Relic from the lost kingdom, Proof of the exile's crimes, Lost weapons shipment to arm supporters`,
    ...
    'Rigid Castes': {
      ...
      enemies: [
        { title: `Conqueror seeking to impose “civilized” castes on outsiders` },
    ...
    'Slave Uprising': {
      ...
      complications: `The slaves are all violent criminals, The captors are willing to let the rank and file rebels live if they hand over their leadership, he uprising is being crushed and will likely not last for much longer, The slaves are recently bolstered by a successful armory raid`,
      things: `Map {to a remote settlement that can take in the slaves|with a safe route out of the region}, Precious relic of their past, Armaments meant to assist the slaves`,
      places: `Field empty of laborers, Gallows festooned with guards, Training field full of slaves with improvised weapons, Riotous slave market`,
      constraints: { urban: true }
    },
    'Stolen Authority': {
      ...
      complications: `The old ruler was hated but this one is even worse, The authority has been seized with no outwardly visible sign of it, The new lord is a catspaw of a foreign power, The new lord has a significant power base among a certain faith or organization`,
      things: `Stash of rebel weaponry, Treasure of the old lord, Savagely extorted tribute shipment, Proof of a usurper’s false lineage`,
      places: `Burnt noble estate, Gallows with dead partisans, Forced assembly to hear new proclamations, Hushed tavern room`
    },
    ...
    'Troubled Festival': {
      ...
      complications: `Two families are fighting over control of the festival, The local priest finds the festival deplorable, A local ruler demands extortionate payment to permit the festival, A location vital to the festival has been rendered dangerous or defiled`,
      things: `Crucial idol, Festival necessity imported from far away, Charter proving the festival's lawfulness, Money raised by it`,
      places: `Hushed festival ground, Empty marketplace, Temple in disarray, Sadly under-occupied tea house`
    },
    'Unique Product': {
      ...
      complications: `The goods are dangerous or toxic to the users, The goods require some morally-dubious ingredient, The product is extremely useful to very unpleasant entities, Multiple rulers claim rights over the community`,
      things: `A cache of the product, The secret method of its production, Valuable components used to make the product, Payment for a shipment, Valuable raw ingredients`,
      places: `Factory full of busy creators, Resource extraction field where a vital component is gathered, Market crowded with traders from far places, Hushed workshop, Hard-bargaining auction hall, Hidden glen where the vital ingredient is grown`
    },
    'Uncertain Title': {
      ...
      complications: `The outsider really does have legal title to the land, The outsider doesn't want the land, but instead wants what's beneath it, The outsider is being pressured by a more nefarious power to get the land- or else`,
    ...
    'Wanted Outlaw': {
      ...
      complications: `The slain are political foes of a local grandee, The locals quietly think the victims needed killing, The apparent killer is being blackmailed by darker forces, The dead are being replaced and impersonated, The outlaw is actually innocent, The outlaw is singled out for his attacks on a corrupt noble, The outlaw is an exiled nobleman`,
      things: `A vital clue, An item to reveal a disguised monster, The thing the murderer seeks from his victims, A list of victims due to die`,
      places: `Desolate alleyway, Gory murder site, Blood-stained altar chamber, Tavern with locals huddling against the night`
    },
    'Warring Council': {
    ...
    'Witch Hunts': {
      ...
      complications: `The sorcerers are being framed by their enemies, The transgression was a great atrocity that left many dead`,
      things: `Confiscated arcane relics, Wealth of a dead sorcerer, Enchanted shackles that nullify magic, Magical item that can be used to identify sorcerers`,
      places: `Scorched arcane sanctuary, Gallows with dead sorcerers, Stockade with sorcerous prisoners, Luxurious manor with a secret torture chamber`
    },
