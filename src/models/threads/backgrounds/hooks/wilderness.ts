...
export const wilderness: Hook = {
  hooks: {
    ...
    Chokepoint: {
      ...
      things: [
        'Map of the passage',
        'Token allowing safe passage',
        'Key to controlling the passage'
      ],
      places: [
        'Perfect ambush site',
        'Natural fortress',
    ...
    'Precious Game': {
      ...
      things: [
        'Trove of beast pelts',
        'Lure for the beasts',
        'Map to their secret breeding grounds'
      ],
      places: [
    ...
    'Uncanny Weather': {
      ...
      enemies: [
        ...
        { title: 'Raging elemental that reflects the phenomena' }
      ],
      friends: [
