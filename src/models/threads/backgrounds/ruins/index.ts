...
export const backgrounds__ruin: Record<Ruins, Background> = {
  'abandoned traps': {
    tag: 'abandoned traps',
    type: 'ruins',
  ...
  'magical wonder': {
    ...
    enemies: [
      ...
      { alias: `Sorcerous monster born of the decay` },
  ...
  'useless treasure': {
    ...
    type: 'ruins',
    context: `The ruin was once a carefully-guarded storehouse of some {substance|information} that was priceless at the time, but is now largely worthless ({obscure materials|exotic matter fashioned by sorcery|critical intelligence on ancient empires}).`,
    enemies: [
