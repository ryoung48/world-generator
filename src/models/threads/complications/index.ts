...
const complication__definition: Record<Complication['tag'], Complication> = {
  ...
  appeal: {
    ...
    type: ['task'],
    text: () =>
      `The rival appeals to the PCs and makes them an offer to switch sides against the interests of the patron.`
  },
  blackmail: {
    tag: 'blackmail',
    type: ['goal'],
  ...
  bolster: {
    ...
    type: ['task'],
    text: () =>
      `The rival {joins forces with another enemy of the patron|acquires a powerful new ally ({blackmail|contract})}.`
  },
  chaos: {
    tag: 'chaos',
    type: ['goal', 'task'],
  ...
  damaged: {
    tag: 'damaged',
    type: ['goal', 'task'],
    text: () => `A key {item|actor} essential to the patron's objective is {cursed|broken|stolen}.`
  },
  diplomatic: {
    tag: 'diplomatic',
    type: ['goal', 'task'],
  ...
  essential: {
    ...
    type: ['task'],
    text: () =>
      `It is revealed that the rival has {key information|hostages} needed to complete the objective, which forces the PCs to negotiate.`
  },
  facade: {
    tag: 'facade',
    type: ['task'],
    text: () => `The rival establishes a good public facing image and gains general local support.`
  },
  hostile: {
    tag: 'hostile',
    type: ['task'],
    text: () =>
      `A {potential ally|neutral actor} {does not like the {patron|PCs}|was a former rival|is {bad|unpleasant}|might be working for the rival} and cannot be trusted.`
  },
  intrigue: {
    tag: 'intrigue',
    type: ['task'],
    text: () =>
      `The rival reveals a secret about the {PCs|patron|allies} that causes {internal|external} {mistrust|confusion}.`
  },
  mastermind: {
    tag: 'mastermind',
    type: ['task'],
    text: () => `It is discovered that the rival is being {blackmailed|led} by a greater villain.`
  },
  misinformation: {
    tag: 'misinformation',
    type: ['task'],
  ...
  morality: {
    ...
    type: ['goal', 'task'],
    text: () =>
      `The objective {has an easy, but morally repugnant, solution ({cruel|bloody|destructive|deceptive|greedy|illegal|taboo})|helps a morally repugnant actor}.`
  },
  obscure: {
    tag: 'obscure',
    type: ['goal'],
    text: () => `The identity of the rival is unknown.`
  },
  reinforcements: {
    tag: 'reinforcements',
    type: ['task'],
  ...
  resources: {
    ...
    type: ['task'],
    text: () =>
      `The rival has obtained essential {resources|object|information} needed to advance their plans.`
  },
  safety: {
    tag: 'safety',
    type: ['task'],
  ...
  scattered: {
    tag: 'scattered',
    type: ['goal', 'task'],
    text: () => `The {map|lead} to the objective is in widely-scattered parts.`
  },
  solitude: {
    tag: 'solitude',
    type: ['goal'],
  ...
  treachery: {
    ...
    type: ['task'],
    text: () =>
      `The {patron has betrayed the PCs after dealing with the foe and enlists minions to remove loose ends|patron's hidden ({dangerous|treacherous}) motives reveal them as the true foe (original rival becomes {the patron|an ally of the former patron})}.`
  },
  trust: {
    tag: 'trust',
    type: ['goal'],
    text: () =>
      `The patron cannot be trusted and is likely to betray the PCs at earliest opportunity.`
  },
  untouchable: {
    tag: 'untouchable',
    type: ['goal'],
    text: () =>
      `The rival is {well-respected|above the law} with many resources and favors at their disposal.`
  },
  weaken: {
    tag: 'weaken',
    type: ['task'],
    text: () =>
      `The rival {destroy|plunder}s {information|an object} that is vital to the patron's plans.`
  }
}
