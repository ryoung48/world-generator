import { ReligionHooks } from './types'

export const religions: ReligionHooks = {
  'Ancient Ways': {
  ...
  'Folk Religion': {
    ...
    constraints: { religion: true, urban: false }
  },
  'Forbidden Faith': {
