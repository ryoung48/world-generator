export const SWN = {
  'Abandoned Colony': {
    text: 'The world once hosted a colony, whether human or otherwise, until some crisis or natural disaster drove the inhabitants away or killed them off. The colony might have been mercantile in nature, an expedition to extract valuable local resources, or it might have been a reclusive cabal of zealots. The remains of the colony are usually in ruins, and might still be dangerous from the aftermath of whatever destroyed it in the first place.',
    friends: [
      'Inquisitive stellar archaeologist',
      'Heir to the colony’s property',
      'Local wanting the place cleaned out and made safe'
    ],
    enemies: ['Crazed survivors', 'Ruthless plunderers of the ruins', 'Automated defense system'],
    complications: [
  ...
  'Altered Humanity': {
    text: 'The humans on this world are visibly and drastically different from normal humanity. They may have additional limbs, new sensory organs, or other significant changes. Were these from ancestral eugenic manipulation, strange stellar mutations, or from an environmental toxin unique to this world?',
    friends: ['Local seeking a “cure”', 'Curious xenophiliac', 'Anthropological researcher'],
    enemies: ['Biochauvinist local', 'Local experimenter', 'Mentally unstable mutant'],
    complications: [
  ...
  Anthropomorphs: {
    ...
    things: ['Pretech gengineering tech', 'A “cure” that may not be wanted', 'Sacred feral totem'],
    places: [
  ...
  'Area 51': {
    text: 'The world’s government is fully aware of their local stellar neighbors, but the common populace has no idea about it- and the government means to keep it that way. Trade with government officials in remote locations is possible, but any attempt to clue the commoners in on the truth will be met with lethal reprisals.',
    friends: [
  ...
  'Badlands World': {
    text: 'Whatever the original climate and atmosphere type, something horrible happened to this world. Biological, chemical, or nanotechnical weaponry has reduced it to a wretched hellscape. Some local life might still be able to survive on its blasted surface, usually at some dire cost in health or humanity.',
    friends: [
      'Native desperately wishing to escape the world',
      'Scientist researching ecological repair methods',
      'Ruin scavenger'
    ],
    enemies: ['Mutated badlands fauna', 'Desperate local', 'Badlands raider chief'],
    complications: ['Radioactivity', 'Bioweapon traces', 'Broken terrain', 'Sudden local plague'],
    things: ['Maltech research core', 'Functional pretech weaponry', 'An uncontaminated well'],
    places: ['Untouched oasis', 'Ruined city', 'Salt flat']
  },
  Battleground: {
    text: 'The world is a battleground for two or more outside powers. They may be interstellar rivals, or groups operating out of orbitals or other system bodies. Something about the planet is valuable enough for them to fight over, but the natives are too weak to be anything but animate obstacles to the fight.',
    friends: [
      'Native desperately seeking protection',
      'Pragmatic military officer',
      'Hapless war orphan'
    ],
    enemies: ['Ruthless military commander', 'Looter pack chieftain', 'Traitorous collaborator'],
    complications: [
    ...
    places: ['Artillery-pocked wasteland', 'Reeking refugee camp', 'Burnt-out shell of a city']
  },
  Beastmasters: {
    text: 'The natives have extremely close bonds with the local fauna, possibly having special means of communication and control through tech or gengineering. Local animal life plays a major role in their society, industry, or warfare, and new kinds of beasts may be bred to suit their purposes.',
    friends: [
  ...
  'Bubble Cities': {
    text: 'Whether due to a lack of atmosphere or an uninhabitable climate, the world’s cities exist within domes or pressurized buildings. In such sealed environments, techniques of surveillance and control can grow baroque and extreme.',
    friends: [
  ...
  'Cheap Life': {
    text: 'Human life is near-worthless on this world. Ubiquitous cloning, local conditions that ensure early death, a culture that reveres murder, or a social structure that utterly discounts the value of most human lives ensures that death is the likely outcome for any action that irritates someone consequential.',
    friends: ['Master assassin', 'Bloody-handed judge', 'Overseer of disposable clones'],
    enemies: [
  ...
  'Civil War': {
    text: 'The world is currently torn between at least two opposing factions, all of which claim legitimacy. The war may be the result of a successful rebel uprising against tyranny, or it might just be the result of schemers who plan to be the new masters once the revolution is complete.',
    friends: [
      'Faction commissar',
      'Angry native',
  ...
  'Cold War': {
    text: 'Two or more great powers control the planet, and they have a hostility to each other that’s just barely less than open warfare. The hostility might be ideological in nature, or it might revolve around control of some local resource.',
    friends: [
  ...
  'Colonized Population': {
    text: 'A neighboring world has successfully colonized this less-advanced or less-organized planet, and the natives aren’t happy about it. A puppet government may exist, but all real decisions are made by the local viceroy.',
    friends: [
  ...
  'Cultural Power': {
    text: 'The world is a considerable cultural power in the sector, producing music, art, philosophy, or some similar intangible that their neighbors find irresistibly attractive. Other worlds might have a profound degree of cultural cachet as the inheritor of some venerable artistic tradition.',
    friends: [
  ...
  Cyborgs: {
    text: 'The planet’s population makes heavy use of cybernetics, with many of the inhabitants possessing at least a cosmetic amount of chrome. This may be the result of a strong local cyber tech base, a religious injunction, or simply a necessary measure to survive the local conditions.',
    friends: [
  ...
  'Desert World': {
    text: 'The world may have a breathable atmosphere and a human-tolerable temperature range, but it is an arid, stony waste outside of a few places made habitable by human effort. The deep wastes are largely unexplored and inhabited by outcasts and worse.',
    friends: ['Native guide', 'Research biologist', 'Aspiring terraformer'],
    enemies: [
      'Raider chieftain',
      'Crazed hermit',
      'Angry isolationists',
    ...
    complications: ['Sandstorms', 'Water supply failure', 'Native warfare over water rights'],
    things: ['Enormous water reservoir', 'Map of hidden wells', 'Pretech rainmaking equipment'],
    places: ['Oasis', '“The Empty Quarter” of the desert', 'Hidden underground cistern']
  },
  'Doomed World': {
    text: 'The world is doomed, and the locals may or may not know it. Some cosmic catastrophe looms before them, and the locals have no realistic way to get everyone to safety. To the extent that the public is aware, society is disintegrating into a combination of religious fervor, abject hedonism, and savage violence.',
    friends: [
  ...
  'Eugenic Cult': {
    text: 'Even in the days before the Silence, major improvement of the human genome always seemed to come with unacceptable side-effects. Some worlds host secret cults that perpetuate these improvements regardless of the cost, and a few planets have been taken over entirely by the cults.',
    friends: [
      'Eugenic superiority fanatic',
      'Mentally unstable homo superior',
      'Mad eugenic scientist'
    ],
    enemies: ['Eugenic propagandist', 'Biotechnical investigator', 'Local seeking revenge on cult'],
    complications: [
  ...
  'Exchange Consulate': {
    text: 'The Exchange of Light once served as the largest, most trusted banking and diplomatic service in human space. Even after the Silence, some worlds retain a functioning Exchange Consulate where banking services and arbitration can be arranged.',
    friends: [
  ...
  'Flying Cities': {
    text: 'Perhaps the world is a gas giant, or plagued with unendurable storms at lower levels of the atmosphere. For whatever reason, the cities of this world fly above the surface of the planet. Perhaps they remain stationary, or perhaps they move from point to point in search of resources.',
    friends: [
      'Rival city pilot',
  ...
  'Forbidden Tech': {
    text: 'Some group on this planet fabricates or uses maltech. Unbraked AIs doomed to metastasize into insanity, nation-destroying nanowarfare particles, slow-burn DNA corruptives, genetically engineered slaves, or something worse still. The planet’s larger population may or may not be aware of the danger in their midst.',
    friends: ['Mad scientist', 'Maltech buyer from offworld', 'Security enforcer'],
    enemies: [
      'Victim of maltech',
      'Perimeter agent',
  ...
  'Former Warriors': {
    text: 'The locals of this world were once famed for their martial prowess. They may have simply had a very militaristic culture, or were genetically engineered for combat, or developed high-tech weaponry, or had brilliant leadership. Those days are past, however, either due to crushing defeat, external restrictions, or a cultural turn toward peace.',
    friends: [
  ...
  'Freak Geology': {
    ...
    friends: ['Crank xenogeologist', 'Cultist who believes it the work of aliens'],
    enemies: ['Research scientist', 'Prospector', 'Artist'],
    complications: [
    ...
    places: ['Atop a bizarre geological formation', 'Tourist resort catering to offworlders']
  },
  'Freak Weather': {
    text: 'The planet is plagued with some sort of bizarre or hazardous weather pattern. Perhaps city-flattening storms regularly scourge the surface, or the world’s sun never pierces its thick banks of clouds.',
    friends: [
    ...
    enemies: ['Meteorological researcher', 'Holodoc crew wanting shots of the weather'],
    complications: [
      'The weather itself',
    ...
    places: ['Eye of the storm', 'The one sunlit place', 'Terraforming control room']
  },
  'Friendly Foe': {
    text: 'Some hostile alien race or malevolent cabal has a branch or sect on this world that is actually quite friendly toward outsiders. For whatever internal reason, they are willing to negotiate and deal honestly with strangers, and appear to lack the worst impulses of their fellows.',
    friends: [
  ...
  'Gold Rush': {
    text: 'Gold, silver, and other conventional precious minerals are common and cheap now that asteroid mining is practical for most worlds. But some minerals and compounds remain precious and rare, and this world has recently been discovered to have a supply of them. People from across the sector have come to strike it rich.',
    friends: ['Paranoid prospector', 'Aspiring mining tycoon', 'Rapacious merchant'],
    enemies: ['Claim-jumped miner', 'Native alien', 'Curious tourist'],
    complications: [
    ...
    places: ['Secret mine', 'Native alien village', 'Processing plant', 'Boom town']
  },
  'Great Work': {
    text: 'The locals are obsessed with completing a massive project, one that has consumed them for generations. It might be the completion of a functioning spaceyard, a massive solar power array, a network of terraforming engines, or the universal conversion of their neighbors to their own faith. The purpose of their entire civilization is to progress and someday complete the work.',
    friends: [
  ...
  'Heavy Industry': {
    text: 'With interstellar transport so limited in the bulk it can move, worlds have to be largely self-sufficient in industry. Some worlds are more sufficient than others, however, and this planet has a thriving manufacturing sector capable of producing large amounts of goods appropriate to its tech level. The locals may enjoy a correspondingly higher lifestyle, or the products might be devoted towards vast projects for the aggrandizement of the rulers.',
    friends: ['Tycoon monopolist', 'Industrial spy', 'Malcontent revolutionary'],
    enemies: ['Aspiring entrepreneur', 'Worker union leader', 'Ambitious inventor'],
    complications: [
  ...
  'Heavy Mining': {
    text: 'This world has large stocks of valuable minerals, usually necessary for local industry, life support, or refinement into loads small enough to export offworld. Major mining efforts are necessary to extract the minerals, and many natives work in the industry.',
    friends: ['Mine boss', 'Tunnel saboteur', 'Subterranean predators'],
    enemies: ['Hermit prospector', 'Offworld investor', 'Miner’s union representative'],
    complications: [
  ...
  'Holy War': {
    text: 'A savage holy war is raging on this world, either between factions of locals or as a united effort against the pagans of some neighboring world. This war might involve a conventional religion, or it might be the result of a branding campaign, political ideology, artistic movement, or any other cause that people use as a substitute for traditional religion.',
    friends: [
      'Blood-mad pontiff',
  ...
  'Hostile Biosphere': {
    text: 'The world is teeming with life, and it hates humans. Perhaps the life is xenoallergenic, forcing filter masks and tailored antiallergens for survival. It could be the native predators are huge and fearless, or the toxic flora ruthlessly outcompetes earth crops.',
    friends: ['Local fauna', 'Nature cultist', 'Native aliens', 'Callous labor overseer'],
    enemies: ['Xenobiologist', 'Tourist on safari', 'Grizzled local guide'],
    complications: [
      'Filter masks fail',
  ...
  'Hostile Space': {
    text: 'The system in which the world exists is a dangerous neighborhood. Something about the system is perilous to inhabitants, either through meteor swarms, stellar radiation, hostile aliens in the asteroid belt, or periodic comet clouds.',
    friends: ['Alien raid leader', 'Meteor-launching terrorists', 'Paranoid local leader'],
    enemies: ['Astronomic researcher', 'Local defense commander', 'Early warning monitor agent'],
    complications: [
  ...
  Immortals: {
    text: 'Natives of this world are effectively immortal. They may have been gengineered for tremendous lifespans, or have found some local anagathic, or be cyborg life forms, or be so totally convinced of reincarnation that death is a cultural irrelevance. Any immortality technique is likely applicable only to them, or else it’s apt to be a massive draw to outside imperialists.',
    friends: [
    ...
    enemies: ['Curious longevity researcher', 'Thrill-seeking local'],
    complications: [
  ...
  'Local Specialty': {
    ...
    things: ['The specialty itself', 'The secret recipe', 'Sample of a new improved variety'],
    places: ['Secret manufactory', 'Hidden cache', 'Artistic competition for best artisan']
  },
  'Local Tech': {
    text: 'The locals can create a particular example of extremely high tech, possibly even something that exceeds pretech standards. They may use unique local resources to do so, or have stumbled on a narrow scientific breakthrough, or still have a functional experimental manufactory.',
    friends: [
      'Keeper of the tech',
    ...
    enemies: ['Curious offworld scientist', 'Eager tech buyer', 'Native in need of technical help'],
    complications: [
  ...
  'Major Spaceyard': {
    ...
    enemies: ['Captain stuck in drydock', 'Maintenance chief', 'Mad innovator'],
    complications: [
  ...
  Mandarinate: {
    text: 'The planet is ruled by an intellectual elite chosen via ostensibly neutral examinations or tests. The values this system selects for may or may not have anything to do with actual practical leadership skills, and the examinations may be more or less corruptible.',
    friends: [
    ...
    things: ['Answer key to the next test', 'Lost essay of incredible merit', 'Proof of cheating'],
    places: [
  ...
  'Mandate Base': {
    text: 'The Terran Mandate retained its control over this world for much longer than usual, and the world may still consider itself a true inheritor of Mandate legitimacy. Most of these worlds have or had superior technology, but they may still labor under the burden of ancient restrictive tech or monitoring systems designed to prevent them from rebelling.',
    friends: [
  ...
  Maneaters: {
    ...
    places: ['Hideous human abattoir', 'Extremely civilized restaurant', 'Funeral-home-cum-kitchen']
  },
  Megacorps: {
    text: 'The world is dominated by classic cyberpunk-esque megacorporations, each one far more important than the vestigial national remnants that encompass them. These megacorps are usually locked in a cold war, trading and dealing with each other even as they try to strike in deniable ways. An over-council of corporations usually acts to bring into line any that get excessively overt in their activities.',
    friends: [
  ...
  Mercenaries: {
    text: 'The world is either famous for its mercenary bands or it is plagued by countless groups of condottieri in service to whatever magnate can afford to pay or bribe them adequately.',
    friends: [
  ...
  'Misandry/Misogyny': {
    text: 'The culture on this world holds a particular gender in contempt. Members of that gender are not permitted positions of formal power, and may be restricted in their movements and activities. Some worlds may go so far as to scorn both traditional genders, using gengineering techniques to hybridize or alter conventional human biology.',
    friends: [
      'Oppressed native',
      'Research scientist',
  ...
  'Night World': {
    text: 'The world is plunged into eternal darkness. The only life on this planet derives its energy from other sources, such as geothermal heat, extremely volatile chemical reactions in the planet’s soil, or light in a non-visible spectrum. Most flora and fauna is voraciously eager to consume other life.',
    friends: [
  ...
  'Police State': {
    text: 'The world is a totalitarian police state. Any sign of disloyalty to the planet’s rulers is punished severely, and suspicion riddles society. Some worlds might operate by Soviet-style informers and indoctrination, while more technically sophisticated worlds might rely on omnipresent cameras or braked AI “guardian angels”. Outworlders are apt to be treated as a necessary evil at best, and “disappeared” if they become troublesome.',
  ...
  'Post-Scarcity': {
    text: 'The locals have maintained sufficient Mandate-era tech to be effectively post-scarcity in their economic structure. Everyone has all the necessities and most of the desires they can imagine. Conflict now exists over the apportionment of services and terrestrial space, since anything else can be had in abundance. Military goods and items of mass destruction may still be restricted, and there is probably some reason that the locals do not export their vast wealth.',
    enemies: [
  ...
  'Primitive Aliens': {
    text: 'The world is populated by a large number of sapient aliens that have yet to develop advanced technology. The human colonists may have a friendly or hostile relationship with the aliens, but a certain intrinsic tension is likely. Small human colonies might have been enslaved or otherwise subjugated.',
    enemies: [
      'Hostile alien chief',
      'Human firebrand',
  ...
  'Prison Planet': {
    text: 'This planet is or was intended as a prison. Some such prisons were meant for specific malefactors of the Terran Mandate, while others were to contain entire “dangerous” ethnic groups or alien races. Some may still have warden AIs or automatic systems to prevent any unauthorized person from leaving, and any authorization permits have long since expired.',
    enemies: [
      'Crazed warden AI',
  ...
  'Psionics Fear': {
    text: 'The locals are terrified of psychics. Perhaps their history is studded with feral psychics who went on murderous rampages, or perhaps they simply nurse an unreasoning terror of those “mutant freaks”. Psychics demonstrate their powers at risk of their lives.',
    enemies: ['Mental purity investigator', 'Suspicious zealot', 'Witch-finder'],
    friends: ['Hidden psychic', 'Offworlder psychic trapped here', 'Offworld educator'],
    complications: [
    ...
    places: ['Inquisitorial chamber', 'Lynching site', 'Museum of psychic atrocities']
  },
  'Psionics Worship': {
    ...
    enemies: ['Psychic inquisitor', 'Haughty mind-noble', 'Psychic slaver', 'Feral prophet'],
    friends: [
  ...
  'Quarantined World': {
    text: 'The world is under a quarantine, and space travel to and from it is strictly forbidden. This may be enforced by massive ground batteries that burn any interlopers from the planet’s sky, or it may be that a neighboring world runs a persistent blockade.',
    enemies: [
  ...
  Refugees: {
    text: 'The world teems with refugees, either exiles from another planet who managed to get here, or the human detritus of some local conflict that have fled to the remaining stable states. The natives usually regard the refugees with hostility, an attitude returned by many among their unwilling guests.',
    enemies: [
  ...
  'Regional Hegemon': {
    text: 'This world has the technological sophistication, natural resources, and determined polity necessary to be a regional hegemon for the sector. Nearby worlds are likely either directly subservient to it or tack carefully to avoid its anger. It may even be the capital of a small stellar empire.',
    ...
    things: ['Diplomatic carte blanche', 'Deed to an offworld estate', 'Foreign aid grant'],
    places: [
  ...
  'Restrictive Laws': {
    text: 'A myriad of laws, customs, and rules constrain the inhabitants of this world, and even acts that are completely permissible elsewhere are punished severely here. The locals may provide lists of these laws to offworlders, but few non-natives can hope to master all the important intricacies.',
    enemies: [
    ...
    friends: ['Frustrated offworlder', 'Repressed native', 'Reforming crusader'],
    complications: [
    ...
    places: ['Courtroom', 'Mob scene of outraged locals', 'Legislative chamber', 'Police station']
  },
  Revanchists: {
    text: 'The locals formerly owned another world, or a major nation on the planet formerly owned an additional region of land. Something happened to take away this control or drive out the former rulers, and they’ve never forgotten it. The locals are obsessed with reclaiming their lost lands, and will allow no questions of practicality to interfere with their cause.',
    enemies: [
  ...
  'Rigid Culture': {
    text: 'The local culture is extremely rigid. Certain forms of behavior and belief are absolutely mandated, and any deviation from these principles is punished, or else society may be strongly stratified by birth with limited prospects for change. Anything which threatens the existing social order is feared and shunned.',
    enemies: ['Rigid reactionary', 'Wary ruler', 'Regime ideologue', 'Offended potentate'],
    friends: ['Revolutionary agitator', 'Ambitious peasant', 'Frustrated merchant'],
    complications: [
    ...
    places: ['Time-worn palace', 'Low-caste slums', 'Bandit den', 'Reformist temple']
  },
  'Rising Hegemon': {
    text: 'This world is not yet a dominant power in the sector, but it’s well on its way there. Whether through newly-blossoming economic, military, or cultural power, they’re extending their influence over their neighbors and forging new arrangements between their government and the rulers of nearby worlds.',
    enemies: [
  ...
  'Seagoing Cities': {
    text: 'Either the world is entirely water or else the land is simply too dangerous for most humans. Human settlement on this world consists of a number of floating cities that follow the currents and the fish. These city-ships might have been purpose-built for their task, or they could be jury-rigged conglomerations of ships and structures thrown together when the need for seagoing life became apparent to the locals.',
    enemies: [
      'Pirate city lord',
  ...
  'Sealed Menace': {
    ...
    friends: ['Keeper of the menace', 'Student of its nature', 'Victim of the menace'],
    complications: [
  ...
  'Secret Masters': {
    ...
    places: ['Smoke-filled room', 'Shadowy alleyway', 'Secret underground bunker']
  },
  Sectarians: {
    text: 'The world is torn by violent disagreement between sectarians of a particular faith. Each views the other as a damnable heresy in need of extirpation. Local government may be able to keep open war from breaking out, but the poisonous hatred divides communities. The nature of the faith may be religious, or it may be based on some secular ideology.',
    enemies: [
      'Paranoid believer',
    ...
    things: ['Ancient holy book', 'Incontrovertible proof', 'Offering to a local holy man'],
    places: [
  ...
  'Seismic Instability': {
    text: 'The local land masses are remarkably unstable, and regular earthquakes rack the surface. Local construction is either advanced enough to sway and move with the vibrations or primitive enough that it is easily rebuilt. Severe volcanic activity may be part of the instability.',
    enemies: [
      'Earthquake cultist',
      'Hermit seismologist',
  ...
  'Societal Despair': {
    text: 'The world’s dominant society has lost faith in itself. Whether through some all-consuming war, great catastrophe, overwhelming outside culture, or religious collapse, the natives no longer believe in their old values, and search desperately for something new. Fierce conflict often exists between the last believers in the old dispensation and the nihilistic or searching disciples of the new age.',
    enemies: [
  ...
  'Taboo Treasure': {
    text: 'The natives here produce something that is both fabulously valuable and strictly forbidden elsewhere in the sector. It may be a lethally addictive drug, forbidden gengineering tech, vat-grown “perfect slaves”, or a useful substance that can only be made through excruciating human suffering. This treasure is freely traded on the world, but bringing it elsewhere is usually an invitation to a long prison stay or worse.',
    enemies: [
  ...
  Tyranny: {
    ...
    things: ['Plundered wealth', 'Beautiful toys of the elite', 'Regalia of rulership'],
    places: [
  ...
  'Unbraked AI': {
    text: "Artificial intelligences are costly and difficult to create, requiring a careful sequence of 'growth stages' in order to bring them to sentience before artificial limits on cognition speed and learning development are installed. This world has an 'unbraked AI' on it, probably with a witting or unwitting corps of servants. Unbraked AIs are quite insane, but they learn and reason with a speed impossible for humans, and can demonstrate a truly distressing subtlety.",
    enemies: ['AI Cultist', 'Maltech researcher', 'Government official dependent on the AI'],
  ...
  Utopia: {
    text: "Natural and social conditions on this world have made it a paradise for its inhabitants, a genuine utopia of happiness and fulfillment. This is normally the result of drastic human engineering, including brain-gelding, neurochemical control, personality curbs, or complete 'humanity' redefinitions. Even so, the natives are extremely happy with their lot, and may wish to extend that joy to poor, sad outsiders.",
    enemies: [
  ...
  Xenophiles: {
    text: 'The natives of this world are fast friends with a particular alien race. The aliens may have saved the planet at some point in the past, or awed the locals with superior tech or impressive cultural qualities. The aliens might even be the ruling class on the planet.',
