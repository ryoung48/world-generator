...
export const courts: HookTemplate = {
  hooks: {
    "Affliction's Mark": {
  ...
  subtype: ({ loc }) => {
    ...
    return window.dice.spin(
      window.dice.weightedChoice([
        { w: village ? 0 : 1, v: `noble household` },
        { w: village ? 0 : 1, v: `{merchant consortium|{merchant|banking} house}` },
        { w: village ? 1 : 0, v: `familial clan` },
