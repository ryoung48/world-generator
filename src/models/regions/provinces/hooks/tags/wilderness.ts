...
export const wilderness: HookTemplate = {
  hooks: {
    'Abandoned Village': {
    ...
    'Sunken Secrets': {
      text: 'A mysterious shipwreck has been discovered off the coast or in a nearby lake or river. It could be an ancient relic of a forgotten civilization, a pirate ship laden with stolen treasure, or perhaps a more recently-sunken vessel carrying a dark secret. The area around the shipwreck may be treacherous, filled with natural or supernatural hazards. Exploring the wreck could reveal valuable items, but also dangerous enemies or complex moral quandaries.',
      enemies: [
        { title: 'Hostile aquatic creatures', monstrous: true },
        { title: 'Treasure-hunting pirates' },
        { title: 'Vengeful ghost of the shipwreck', monstrous: true }
      ],
      friends: [
        { title: 'Local fisherman who discovered the wreck' },
        { title: 'Historian interested in the ship’s origins' },
        { title: 'Survivor of the wreck with vital information' }
      ],
      complications: [
        'The shipwreck is in a legally disputed area',
        'The ship carries a cursed or hazardous cargo',
        'Local authorities are also investigating the wreck for their own purposes'
      ],
      things: [
        'Ancient maritime artifacts',
        'Stolen treasure hoard',
        'Journal detailing the last days of the ship'
      ],
      places: [
        'Sunken cabin filled with relics',
        'Treacherous coral reefs around the wreck',
        'Nearby underwater cave with clues to the wreck'
      ],
  ...
  subtype: ({ loc }) => window.dice.spin(PROVINCE.terrain(loc))
}
