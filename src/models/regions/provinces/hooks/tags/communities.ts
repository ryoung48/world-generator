...
export const communities: HookTemplate = {
  hooks: {
    ...
    'Angry Ghosts': {
      text: 'The locals have done something to provoke the dead, leaving them to be plagued by furious undead and restless ghosts. Only by destroying the undead or resolving the offense can these wraiths find peace.',
      enemies: [
        { title: 'Meddlesome necromancer' },
        { title: 'Vengeful wraith', monstrous: true },
        { title: 'Negligent priest' },
        { title: 'Grasping tomb-robber' }
      ],
      friends: [
        { title: "Ghost's surviving relative" },
        { title: 'Distressed cemetery keeper' },
        { title: 'Inquiring official' },
        { title: 'Local priest' },
        { title: 'Veteran undead-hunter' }
      ],
      complications: [
      ...
      places: [
        ...
        'The site of a terrible crime',
        'Ornate crypt',
        'Derelict haunted locale'
      ]
    },
    'Awful Curse': {
      text: "This community has been cursed with some blight that makes life difficult, albeit not impossible. The curse is the result of {an offended sorcerer's vengeful enchantment|the wrath of an eldritch spirit|anomalous arcane distortion}.",
      enemies: [
    ...
    Crackdown: {
      ...
      friends: [
        { title: 'Fellow outsider trapped in the community' },
    ...
    'Floating Market': {
      text: 'An intricate network of boats, barges, and floating platforms creates a vibrant market that defies traditional governance. The market offers exotic goods, illegal wares, and rare information. However, the makeshift quality of this place makes it vulnerable to both the elements and to criminal activity. Deals made here often carry risks, but also the allure of high rewards. Depending on the tide, the layout may change, making it a maze even for locals.',
      enemies: [
        { title: 'Pirate Lord controlling a portion of the market' },
        { title: 'Unscrupulous trader peddling cursed goods' },
        { title: 'Pirate preying on market boats' },
        { title: 'Corrupt enforcers shaking down vendors' },
        { title: 'Smuggler with a dark secret' }
      ],
      friends: [
        { title: 'Honest merchant in a den of thieves' },
        { title: 'Local guide who knows the market like the back of their hand' },
        { title: 'Undercover investigator searching for evidence' },
        { title: 'Harbormaster trying to bring some order' },
        { title: 'Local law enforcement trying to maintain order' }
      ],
      complications: [
        'The market moves to a different location every week',
        'High tide brings in dangerous sea creatures',
        'The governing authority is planning to shut it down',
        'An underground auction of forbidden artifacts is taking place',
        'A notorious criminal gang uses the market as a recruiting ground',
        'The market is a front for an underground rebellion',
        'The market is a neutral ground for warring factions, making tensions high'
      ],
      things: [
        'Ancient map leading to an uncharted island',
        'A stolen trinket that’s more than it appears',
        'Contraband magic potions with unpredictable effects',
        'A ledger detailing black market activities',
        'Sacred artifact hidden among mundane wares'
      ],
      places: [
        'Floating tavern where rumors and secrets flow as freely as ale',
        'An unassuming boat that serves as the front for a spy ring',
        'Underwater cave, accessible only through a hidden trapdoor in the market',
        'Boat filled with exotic animals and pets',
        'Floating stage for entertainers and musicians',
        'Secret chamber where high-stakes auctions occur'
      ]
    },
    'Forced Evictions': {
    ...
    'River Barges': {
      text: 'A large river is the primary means of transporting goods between settlements. Recently, shipments have gone missing, and strange occurrences have been reported on board. Locals are hesitant to speak about it openly, but it’s clear that the barge is attracting unsavory attention for some reason. Whether it’s cursed, targeted by bandits, or part of some grander scheme, the river is now the focus of many whispered rumors.',
      enemies: [
        { title: 'Ruthless river pirate' },
        { title: 'Saboteur working for rival traders' },
        { title: 'Water-dwelling monster', monstrous: true }
      ],
      friends: [
        { title: 'Worried barge captain' },
        { title: 'Local merchant dependent on the river trade' },
        { title: 'River guard investigating the incidents' }
      ],
      complications: [
        'The missing barge was carrying something illegal or cursed',
        'There is a suspected traitor among one of the barge crews',
        'The river itself is undergoing strange magical changes'
      ],
      things: [
        'Stolen shipment of valuable goods',
        'Ancient artifact hidden on the barge',
        'Navigational maps showing secret routes'
      ],
      places: [
        'Hidden cove used by pirates',
        'The barge’s heavily guarded cargo hold',
    ...
    'Seat of Rule': {
      ...
      constraints: { urban: true, capital: true }
    },
    'Secret Treachery': {
