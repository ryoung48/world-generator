import { Biome, BiomeDetails, ClimateZone } from './types'

const diurnalVariation: Record<BiomeDetails['diurnalVariation'], [number, number]> = {
  low: [10, 3],
  standard: [15, 3.5],
  high: [20, 4]
}
...
const zones: Record<BiomeDetails['latitude'], ClimateZone> = {
  tropical: 'tropical',
...
export const BIOME = {
  holdridge,
  zone: zones,
  diurnalVariation: (biome: BiomeDetails) => diurnalVariation[biome.diurnalVariation]
}
